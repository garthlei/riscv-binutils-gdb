...
#define MATCH_CTRLSIG_S 0xb
#define MASK_CTRLSIG_S 0xff
#define MATCH_CTRLSIG_M 0x8b
#define MASK_CTRLSIG_M 0xff
#define MATCH_CRCSIG 0xab
#define MASK_CRCSIG 0xffff
#define MATCH_PUSHSIG 0x12b
#define MASK_PUSHSIG 0xffffffff
#define MATCH_POPSIG 0x1ab
#define MASK_POPSIG 0xffffffff
...
DECLARE_INSN(ctrlsig_s, MATCH_CTRLSIG_S, MASK_CTRLSIG_S)
DECLARE_INSN(ctrlsig_m, MATCH_CTRLSIG_M, MASK_CTRLSIG_M)
DECLARE_INSN(crcsig, MATCH_CRCSIG, MASK_CRCSIG)
DECLARE_INSN(pushsig, MATCH_PUSHSIG, MASK_PUSHSIG)
DECLARE_INSN(popsig, MATCH_POPSIG, MASK_POPSIG)
